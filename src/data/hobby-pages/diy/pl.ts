import type { DiyPageContent } from ".";

export const pl: DiyPageContent = {
	...
	highlights: [
		{
			title: "Tworzenie dla bliskich",
			description:
				"Największą satysfakcję daje mi moment, kiedy ktoś cieszy się z prezentu i widzi, że powstał specjalnie z myślą o nim.",
		},
		{
		...
		},
		{
			...
			description:
				"Kiedy coś mnie zainspiruje, pomysł pojawia się natychmiast. Najlepiej wtedy od razu kupić materiały, zanim projekt zdąży trafić na listę „kiedyś”.",
		},
	],

	originTitle: "Skąd się wzięło to zainteresowanie?",

	originParagraphs: [
		"Tworzenie było obecne w moim życiu od dzieciństwa. Razem z mamą robiłyśmy różne dekoracje i drobiazgi, a kiedy miałam około ośmiu lat, ciocia podarowała mi książkę „Każde dziecko to potrafi”. Przez wiele lat wracałam do zawartych w niej pomysłów i wykonywałam kolejne projekty.",

		"Później uczyłam się od mamy haftowania, szydełkowania, robienia na drutach i scrapbookingu. Kiedy byłam już dorosła, jeździłyśmy razem na warsztaty do Ustronia, gdzie poznawałyśmy nowe techniki rękodzielnicze.",

		"Z czasem zaczęłam coraz częściej tworzyć z myślą o konkretnych osobach. Własnoręcznie wykonane rzeczy stały się dla mnie sposobem okazywania troski i dawania komuś czegoś, czego nie da się po prostu zdjąć z półki w sklepie.",
	],
	...
	stories: [
		{
			...
			title: "Stańczyk Matejki",
			summary:
				"Haft, który miał być ambitnym projektem na koniec gimnazjum, a ostatecznie towarzyszył mi jeszcze przez liceum.",
		...
		{
			label: "Najbardziej osobisty projekt",
			title: "Poduszki dla bliźniaczek",
			summary:
		...
		{
			label: "Pierwszy ważny prezent",
			title: "Diabełek z włóczki",
			summary:
				"Prezent z czasów, kiedy mieliśmy po około piętnaście lat i woleliśmy wydać pieniądze na wspólną wycieczkę.",

			paragraphs: [
				"Kiedy mieliśmy z mężem po około piętnaście lat, nie dysponowaliśmy dużymi pieniędzmi. Oboje woleliśmy przeznaczyć je na wspólną wycieczkę niż kupować sobie przypadkowe prezenty.",
	...
	quote:
		"Najbardziej lubię moment, kiedy ktoś cieszy się z prezentu i widzi, że powstał specjalnie dla niego.",
	...
	lookingAhead: [
		...
		{
			title: "Rozwijać haftowanie",
			description:
				"Haft nadal daje mi najwięcej radości, dlatego chcę wracać do większych i bardziej wymagających projektów.",
		},
		{
	...
	galleryIntroduction:
		"Hafty, dekoracje, obrazy, skrzyneczki i projekty, które znalazły swoje miejsce w naszym domu lub trafiły do bliskich.",

	galleryImages: [
		{
			alt: "Haft przedstawiający Stańczyka według obrazu Jana Matejki",
		},
		{
			alt: "Haftowane poduszki z motywami zebry i żyrafy dla bliźniaczek",
		},
		{
			alt: "Diabełek wykonany z włóczki jako prezent",
		},
		{
			alt: "Własnoręcznie ozdobione skrzyneczki na biżuterię",
		},
		{
			alt: "Ozdoby choinkowe wykonane ze wstążek",
		},
		{
			alt: "Obraz wykonany techniką diamond painting",
		},
	],
};